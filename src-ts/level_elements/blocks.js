...
Blocks = (function() {
  ...
  Blocks.prototype.parse = function(xml) {
    var block, i, j, k, len, len1, len2, material, vertex, xml_block, xml_blocks, xml_material, xml_materials, xml_vertex, xml_vertices;
  ...
  Blocks.prototype.init_sprites = function() {
    var block, i, j, len, len1, mask, points, ref, ref1, results, size_x, size_y, texture, vertex;
